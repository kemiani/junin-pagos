// SVG Icons como Server Components (0 JS)
// Solo se renderizan en el servidor como HTML estático
...
export function ServicesIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path
        strokeLinecap="round"
