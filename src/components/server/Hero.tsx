        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-6">
              {["Alta en 48hs", "Soporte humano"].map((text) => (
          ...
          {/* Imagen del cohete con glow */}
          <div className="hidden lg:flex justify-center items-center relative">
            {/* Glow dorado difuminado detras */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-80 h-80 bg-amber-500/20 rounded-full blur-3xl" />
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-64 h-64 bg-yellow-400/15 rounded-full blur-2xl" />
            </div>
            ...
            <div className="relative animate-float">
              <Image
                src="/junin-pagos.png"
                alt="Cohete despegando de monedas - Junin Pagos"
                width={420}
                height={420}
                priority
